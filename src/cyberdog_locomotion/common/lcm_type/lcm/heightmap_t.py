...
class heightmap_t(object):
    ...
    __dimensions__ = [[80, 80], [3]]

    def __init__(self):
        self.map = [ [ 0.0 for dim1 in range(80) ] for dim0 in range(80) ]
    ...
    def _encode_one(self, buf):
        for i0 in range(80):
            buf.write(struct.pack('>80d', *self.map[i0][:80]))
    ...
    def _decode_one(buf):
        ...
        self.map = []
        for i0 in range(80):
            self.map.append(struct.unpack('>80d', buf.read(640)))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x30febfc055ab862c) & 0xffffffffffffffff
