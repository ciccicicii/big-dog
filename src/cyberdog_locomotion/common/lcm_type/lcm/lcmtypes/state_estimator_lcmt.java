...
public final class state_estimator_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public float vBody[];
    public float p_abs[];
    public float vWorld_abs[];
    public float vBody_abs[];
    ...
    public state_estimator_lcmt()
    {
        ...
        vBody = new float[3];
        p_abs = new float[3];
        vWorld_abs = new float[3];
        vBody_abs = new float[3];
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x0c69618890a997afL;
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        for (int a = 0; a < 3; a++) {
            outs.writeFloat(this.p_abs[a]); 
        }
 
        for (int a = 0; a < 3; a++) {
            outs.writeFloat(this.vWorld_abs[a]); 
        }
 
        for (int a = 0; a < 3; a++) {
            outs.writeFloat(this.vBody_abs[a]); 
        }
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.p_abs = new float[(int) 3];
        for (int a = 0; a < 3; a++) {
            this.p_abs[a] = ins.readFloat();
        }
 
        this.vWorld_abs = new float[(int) 3];
        for (int a = 0; a < 3; a++) {
            this.vWorld_abs[a] = ins.readFloat();
        }
 
        this.vBody_abs = new float[(int) 3];
        for (int a = 0; a < 3; a++) {
            this.vBody_abs[a] = ins.readFloat();
        }
    ...
    public lcmtypes.state_estimator_lcmt copy()
    {
        ...
        outobj.p_abs = new float[(int) 3];
        System.arraycopy(this.p_abs, 0, outobj.p_abs, 0, 3); 
        outobj.vWorld_abs = new float[(int) 3];
        System.arraycopy(this.vWorld_abs, 0, outobj.vWorld_abs, 0, 3); 
        outobj.vBody_abs = new float[(int) 3];
        System.arraycopy(this.vBody_abs, 0, outobj.vBody_abs, 0, 3); 
