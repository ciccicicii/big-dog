...
public final class heightmap_t implements lcm.lcm.LCMEncodable
{
    ...
    public heightmap_t()
    {
        map = new double[80][80];
        robot_loc = new double[3];
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x30febfc055ab862cL;
    ...
    {
        this.map = new double[(int) 80][(int) 80];
        for (int a = 0; a < 80; a++) {
            for (int b = 0; b < 80; b++) {
    ...
    public lcmtypes.heightmap_t copy()
    {
        ...
        outobj.map = new double[(int) 80][(int) 80];
        for (int a = 0; a < 80; a++) {
            System.arraycopy(this.map[a], 0, outobj.map[a], 0, 80);        }
