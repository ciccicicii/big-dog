...
public final class spi_data_t implements lcm.lcm.LCMEncodable
{
    ...
    public short tmp_abad[];
    public short tmp_hip[];
    public short tmp_knee[];
    public byte reserve[];
    ...
    public spi_data_t()
    {
        ...
        tmp_abad = new short[4];
        tmp_hip = new short[4];
        tmp_knee = new short[4];
        reserve = new byte[40];
    }
 
    public static final long LCM_FINGERPRINT;
    public static final long LCM_FINGERPRINT_BASE = 0x4da50a8960be7463L;
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        for (int a = 0; a < 4; a++) {
            outs.writeShort(this.tmp_abad[a]); 
        }
 
        for (int a = 0; a < 4; a++) {
            outs.writeShort(this.tmp_hip[a]); 
        }
 
        for (int a = 0; a < 4; a++) {
            outs.writeShort(this.tmp_knee[a]); 
        }
 
        outs.write(this.reserve, 0, 40);
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.tmp_abad = new short[(int) 4];
        for (int a = 0; a < 4; a++) {
            this.tmp_abad[a] = ins.readShort();
        }
 
        this.tmp_hip = new short[(int) 4];
        for (int a = 0; a < 4; a++) {
            this.tmp_hip[a] = ins.readShort();
        }
 
        this.tmp_knee = new short[(int) 4];
        for (int a = 0; a < 4; a++) {
            this.tmp_knee[a] = ins.readShort();
        }
 
        this.reserve = new byte[(int) 40];
        ins.readFully(this.reserve, 0, (int) 40); 
    }
    ...
    public lcmtypes.spi_data_t copy()
    {
        ...
        outobj.tmp_abad = new short[(int) 4];
        System.arraycopy(this.tmp_abad, 0, outobj.tmp_abad, 0, 4); 
        outobj.tmp_hip = new short[(int) 4];
        System.arraycopy(this.tmp_hip, 0, outobj.tmp_hip, 0, 4); 
        outobj.tmp_knee = new short[(int) 4];
        System.arraycopy(this.tmp_knee, 0, outobj.tmp_knee, 0, 4); 
        outobj.reserve = new byte[(int) 40];
        System.arraycopy(this.reserve, 0, outobj.reserve, 0, 40); 
        return outobj;
    }
