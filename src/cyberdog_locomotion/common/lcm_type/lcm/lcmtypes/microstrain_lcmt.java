...
public final class microstrain_lcmt implements lcm.lcm.LCMEncodable
{
    ...
    public static final long LCM_FINGERPRINT_BASE = 0x5cd056dfbad25aebL;
    ...
    public void _encodeRecursive(DataOutput outs) throws IOException
    {
        ...
        for (int a = 0; a < 3; a++) {
            outs.writeFloat(this.rpy_imu[a]); 
        }
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.rpy_imu = new float[(int) 3];
        for (int a = 0; a < 3; a++) {
            this.rpy_imu[a] = ins.readFloat();
        }
    ...
    public lcmtypes.microstrain_lcmt copy()
    {
        ...
        outobj.rpy_imu = new float[(int) 3];
        System.arraycopy(this.rpy_imu, 0, outobj.rpy_imu, 0, 3); 
