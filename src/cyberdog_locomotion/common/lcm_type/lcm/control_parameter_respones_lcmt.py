...
class control_parameter_respones_lcmt(object):
    ...
    __dimensions__ = [[64], None, [96], None, None]

    def __init__(self):
        self.name = [ 0 for dim0 in range(64) ]
        self.requestNumber = 0
        self.value = [ 0 for dim0 in range(96) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>96b', *self.value[:96]))
    ...
    def _decode_one(buf):
        ...
        self.value = struct.unpack('>96b', buf.read(96))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xe827e9f5f21296b9) & 0xffffffffffffffff
